...
export default {   
    ...
    setup(){ 
        ...
        const {obtenerDatos , datosState , obtenerCantidadPaginas , datosCantidadPaginasState , irPaginaAnterior , cantidadPaginaActual , obtenerDatosTodos , borrar , obtenerId , datosPorId} = useFormularioDetalle()
        ...
        return  {
            ...
            traerIdEditar: async( dato )=>{                    
                await obtenerId(dato)                
                document.getElementById("nombreFormularioEditFormularioDetalle").value = datosPorId.value[0]['for_nombre']

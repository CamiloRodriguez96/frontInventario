...
export default {   
    setup(){ 
        ...
        const {obtenerDatos , datosState , obtenerCantidadPaginas , datosCantidadPaginasState , cantidadPaginaActual , obtenerDatosTodos} = useRegistro()
